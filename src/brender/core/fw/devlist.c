...
br_error (C2_HOOK_STDCALL * devAdd_original)(br_device** pdev, br_device_begin_fn* dev_begin, const char* args, br_image* image);
...
br_error (C2_HOOK_CDECL * BrDevAdd_original)(br_device** pdev, char* image, const char* args);
br_error C2_HOOK_CDECL BrDevAdd(br_device** pdev, char* image, const char* args) {
#if 0//defined(C2_HOOKS_ENABLED)
...
br_error (C2_HOOK_CDECL * BrDevCheckAdd_original)(br_device** pdev, char* name, const char* args);
br_error C2_HOOK_CDECL BrDevCheckAdd(br_device** pdev, char* name, const char* args) {
#if 0//defined(C2_HOOKS_ENABLED)
...
br_error (C2_HOOK_CDECL * BrDevFindMany_original)(br_device** devices, br_int_32* ndevices, br_int_32 max_devices, const char* pattern);
...
br_error (C2_HOOK_CDECL * BrDevCount_original)(br_int_32* ndevices, const char* pattern);
...
br_error (C2_HOOK_CDECL * BrDevContainedFind_original)(br_object** ph, br_token type, const char* pattern, br_token_value* tv);
...
br_error (C2_HOOK_CDECL * BrDevContainedFindMany_original)(br_object** objects, br_int_32 max_objects, br_int_32* pnum_objects, br_token type, const char* pattern, br_token_value* tv);
...
br_error (C2_HOOK_CDECL * BrDevContainedCount_original)(br_int_32* pcount, br_token type, const char* pattern, br_token_value* tv);
