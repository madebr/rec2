...
br_error (C2_HOOK_CDECL * BrDevAdd_original)(br_device** pdev, const char* image, const char* args);
...
br_error (C2_HOOK_CDECL * BrDevCheckAdd_original)(br_device** pdev, const char* name, const char* args);
...
br_error (C2_HOOK_CDECL * BrDevAddConfig_original)(const char* config);
