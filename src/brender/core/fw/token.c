...
C2_HOOK_VARIABLE_IMPLEMENT_ARRAY_INIT(br_token_entry, predefinedTokens, 461, 0x00667f48, {
    ...
    { { NULL, NULL }, "BUCKET_AND_BUFFER",           BRT_NONE,              BRT_BUCKET_AND_BUFFER,          17  },
    ...
    { { NULL, NULL }, "NEW_BLEND_B",                 BRT_BOOLEAN,           BRT_NEW_BLEND_B,                9   },
    ...
    { { NULL, NULL }, "POINT_LOCAL_1",               BRT_NONE,              BRT_POINT_LOCAL_1,              13  },
    { { NULL, NULL }, "POINT_LOCAL_2",               BRT_NONE,              BRT_POINT_LOCAL_2,              13  },
