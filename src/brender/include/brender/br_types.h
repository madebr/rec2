...
typedef br_size_t brfile_write_cbfn(const void*, br_size_t, unsigned int, void*);
...
typedef struct br_object_container_dispatch {
    ...
    br_error (*_count)(br_object_container*, br_int_32*, br_token, const char*, br_token_value*);
...
typedef struct br_renderer_dispatch {
    ...
    br_error (C2_HOOK_CDECL *_count)(br_object_container*, br_int_32*, br_token, const char*, br_token_value*);
