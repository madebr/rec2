...
typedef struct tCar_spec {
    ...
    undefined field17_0x90[28];
    tU16 fire_vertex[12];
    float dt;
    undefined* field20_0xc8;
    char name[32];
    char driver_name[32];
    char grid_icon_names[3][14];
    undefined field24_0x136;
    undefined field25_0x137;
    ...
    float bounce_rate;
    float bounce_amount;
    undefined field141_0x4c8[4];
    float damage_multiplier;
    float grip_multiplier;
    undefined field144_0x4d4[4];
    ...
    float maxcurve;
    float turn_speed;
    float field172_0x1260;
    int oldd[4];
    int material_index[4];
    undefined field175_0x1284[16];
    br_vector3 mu;
    float traction_fractional_multiplier;
    float downforce_to_weight;
    undefined field179_0x12a8;
    undefined field180_0x12a9;
    undefined field181_0x12aa;
    undefined field182_0x12ab;
    float initial_brake;
    ...
    tU32 keys;
    undefined field193_0x12d4[8];
    int joystick_acc;
    int joystick_dec;
    undefined field196_0x12e4[4];
    int number_of_wheels_on_ground;
    br_actor* wheel_actors[6];
    br_actor* pivot_actors[6];
    undefined field200_0x131c[32];
    float damage_magnitude_accumulator;
    float revs;
    float target_revs;
    undefined field204_0x1348[12];
    ...
    float field216_0x13ac;
    float field217_0x13b0;
    br_vector3 pre_car_col_velocity;
    float pre_car_col_velocity_car_space;
    float field220_0x13c4;
    float field221_0x13c8;
    undefined field222_0x13cc[20];
    float field223_0x13e0;
    int time_last_hit;
    int time_last_victim;
    undefined* last_hit_by;
    undefined* field227_0x13f0;
    ...
    tU32 last_bounce;
    int new_skidding;
    undefined field247_0x15a0[12];
    br_vector3 field248_0x15ac[4];
    undefined field249_0x15dc[240];
    float oil_remaining[4];
    float maybe_blood_remaining[4];
    float maybe_total_length[4];
    undefined4 field253_0x16fc[4];
    float proxy_ray_distance;
    int powerups[80]; /* unknown_size */
    undefined field256_0x1850[80];
    int time_to_recover;
    undefined field258_0x18a4[4];
    int power_up_levels[3];
    int power_up_slots[3];
    int horn_sound_tag;
    int is_girl;
    undefined field263_0x18c8[4];
    int field264_0x18cc;
    ...
    undefined4 field273_0x195c;
    undefined field274_0x1960[4];
} tCar_spec;
