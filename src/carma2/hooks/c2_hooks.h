...
#define C2_HOOK_VARIABLE_DECLARE_ARRAY_ADV(TYPE, NAME, ADV) HOOK_VARIABLE_DECLARE_ARRAY_ADV(TYPE, NAME, ADV)
...
#define C2_HOOK_VARIABLE_IMPLEMENT_ARRAY_ADV(TYPE, NAME, ADV, ADDRESS) HOOK_VARIABLE_IMPLEMENT_ARRAY_ADV(TYPE, NAME, ADV, ADDRESS)
#define C2_HOOK_VARIABLE_IMPLEMENT_ARRAY_ADV_INIT(TYPE, NAME, ADV, ADDRESS, ...) HOOK_VARIABLE_IMPLEMENT_ARRAY_ADV(TYPE, NAME, ADV, ADDRESS)
