...
#define NOT_IMPLEMENTED() _Static_assert(0, "Not implemented")
...
#define C2_HOOK_VARIABLE_NOEXTERN(TYPE, NAME) HOOK_VARIABLE_DECLARE_NOEXTERN(TYPE, NAME)
#define C2_HOOK_VARIABLE_DECLARE_STATIC(TYPE, NAME) HOOK_VARIABLE_DECLARE_STATIC(TYPE, NAME)
...
#if defined(REC2_ABORT_UNIMPLEMENTED)
#include "stdlib.h"
...
#define C2_HOOK_VARIABLE_DECLARE_STATIC(TYPE, NAME) static TYPE NAME;
#define C2_HOOK_VARIABLE_DECLARE_ARRAY(TYPE, NAME, COUNT) extern TYPE NAME[COUNT];
#define C2_HOOK_VARIABLE_DECLARE_ARRAY_ADV(TYPE, NAME, ADV) extern TYPE NAME ADV;
...
#define C2_HOOK_VARIABLE_IMPLEMENT_ARRAY_ADV(TYPE, NAME, ADV, ADDRESS) TYPE NAME ADV
#define C2_HOOK_VARIABLE_IMPLEMENT_ARRAY_ADV_INIT(TYPE, NAME, ADV, ADDRESS, ...) TYPE NAME ADV = __VA_ARGS__
