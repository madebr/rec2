...
C2_HOOK_VARIABLE_DECLARE(tU32, gWait_for_it);
...
C2_HOOK_VARIABLE_DECLARE(int, gAFE);
...
C2_HOOK_VARIABLE_DECLARE(tU32, gI_am_cheating);
...
C2_HOOK_VARIABLE_DECLARE(float, gPinball_factor);
C2_HOOK_VARIABLE_DECLARE(float, gOpponent_speed_factor);
...
C2_HOOK_VARIABLE_DECLARE(float, gGravity_multiplier);
//extern float gCar_crush_wibble;
//extern float gRepair_cost[3];
C2_HOOK_VARIABLE_DECLARE(float, gCop_speed_factor);
C2_HOOK_VARIABLE_DECLARE(float, gDefault_gravity);
C2_HOOK_VARIABLE_DECLARE(tU32, gKeys_pressed);
//extern tSpecial_volume* gDefault_water_spec_vol;
//extern float gNet_repair_cost[7];
C2_HOOK_VARIABLE_DECLARE(tU32, gLast_replay_frame_time);
...
C2_HOOK_VARIABLE_DECLARE(tU32, gRace_finished);
...
C2_HOOK_VARIABLE_DECLARE(br_scalar, gCamera_hither);
...
C2_HOOK_VARIABLE_DECLARE(tU32, gKnobbled_frame_period);
...
C2_HOOK_VARIABLE_DECLARE(int, gShow_opponents);
C2_HOOK_VARIABLE_DECLARE(int, gTotal_laps);
C2_HOOK_VARIABLE_DECLARE(int, gFree_repairs);
C2_HOOK_VARIABLE_DECLARE(int, gFreeze_timer);
//extern int gRoll_over_creds[3];
C2_HOOK_VARIABLE_DECLARE(int, gShow_peds_on_map);
C2_HOOK_VARIABLE_DECLARE(int, gOn_drugs);
//extern int gWasted_time[3];
C2_HOOK_VARIABLE_DECLARE(int, gCheckpoint);
//extern int gRoll_over_time[3];
//extern int gWasted_creds[3];
C2_HOOK_VARIABLE_DECLARE(tU32, gTimer);
C2_HOOK_VARIABLE_DECLARE(int, gCheckpoint_count);
C2_HOOK_VARIABLE_DECLARE(int, gCountdown);
C2_HOOK_VARIABLE_DECLARE(int, gFrame_rate);
