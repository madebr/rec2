...
C2_HOOK_VARIABLE_IMPLEMENT_INIT(int, gINT_00595c20, 0x00684548, 9998);
...
C2_HOOK_VARIABLE_IMPLEMENT_ARRAY_INIT(int, gRandom_CDA_tunes_1, 4, 0x00595ca8, { 9600, 9601, 9602, 9603 });
