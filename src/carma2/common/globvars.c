...
C2_HOOK_VARIABLE_IMPLEMENT(int, gNo_2d_effects, 0x0074cf68);
...
C2_HOOK_VARIABLE_IMPLEMENT(tU32, gWait_for_it, 0x0075b8f0);
...
C2_HOOK_VARIABLE_IMPLEMENT(tU32, gKnobbled_frame_period, 0x007634f0);
//int gWait_for_it;
