...
C2_HOOK_VARIABLE_IMPLEMENT_ARRAY(char, gQuicktime_temp_path, 256, 0x00705440);
C2_HOOK_VARIABLE_IMPLEMENT_ARRAY(char, gQuicktime_move_path_stub, 256, 0x00705240);
C2_HOOK_VARIABLE_IMPLEMENT_ARRAY(char, gQuicktime_banner_texture_name, 256, 0x00705340);
...
void C2_HOOK_CDECL InitQuickTimeStuff(void) {
    ...
    C2V(gQuicktime_temp_path)[0] = '\0';
    C2V(gQuicktime_move_path_stub)[0] = '\0';
    C2V(gQuicktime_banner_texture_name)[0] = '\0';
#endif
}
